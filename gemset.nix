{
  ...
  async = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0d7804190igznhbm9vc1f4j34lsq2q5qsq5qkxk7fdh2d3ljqy8g";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  console = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0n1d9055jr98mqsx59bvzrpr7r8gf4qhr3y2klzwikkcc2znl0qw";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  minitest-hooks = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "1i1jdx6s8acrqss3c00gcpsl3jki1ij8qdgwpr31cvbyyhxxsl7g";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  rbi = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0aflv0app040py3sn3fd6yjsvqjiwzx4gvw19z9w5yjzpqr0ys7c";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  sorbet = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0wyac6zmgi5kzzvb190gdhmvc97ifpfkdq3bkv5rf7brl51v1cvp";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  sorbet-runtime = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "05rhqjhrah4b8hxf05k81l5dsqb82xf0n97sq424c16jgjg0vg9n";
      target = "ruby";
      type = "gem";
    };
    targets = [];
  ...
  sorbet-static = {
    ...
    targets = [{
      remotes = ["https://rubygems.org"];
      sha256 = "1l1zdia5nlimq3bzhgmibngf12wgc8kkcwd6hs1jinjqpa281g5j";
      target = "x86_64-linux";
      targetCPU = "x86_64";
      targetOS = "linux";
      type = "gem";
  ...
  sorbet-static-and-runtime = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0gb23p39bymh7jv0c84fgdzz2c4772znv5x1kk2dgprlxdkkwysl";
      target = "ruby";
      type = "gem";
    };
    targets = [];
